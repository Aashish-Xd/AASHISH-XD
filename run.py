...
\033[1;91m╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝╚═╝╚═════╝░╚═╝░░╚═╝
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ AASHISH CHHETRI ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
\x1b[31;1m   \x1b[47;2m[ THIS TOOL IS FREE ]\x1b[00;1m\x1b[31;1m \x1b[31;1m \x1b[47;2m[ POWERED BY AASHISH ]\x1b[00;1m\x1b[31;1m
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃AASHISH CHHETRI⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
❣︎[𖣘]☔︎CREATED BY   :  AASHISH_XD
❣︎[𖣘]☔︎ FB NAME     : AASHISH CHHETRI
❣︎[𖣘]☔︎ON GITHUB    :  AASHISH_XD
...
def setting():
	...
	print(" [\u001b[36m3\033[1;37m] TIK TOK IDZ")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[AASHISH-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
